...
Qulture & Art is a user-generated platform designed and coded in Flask. Includes implementation of Google OAuth, a payment gateway, and a backend server hosted on AWS. Live demo: https://web-production-0082.up.railway.app/
